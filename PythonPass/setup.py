...
setup(
    name='PyPass',
    version='1.0',
    packages=['venv.Lib.site-packages.cffi', 'venv.Lib.site-packages.idna', 'venv.Lib.site-packages.mysql',
              'venv.Lib.site-packages.mysql.connector', 'venv.Lib.site-packages.mysql.connector.django',
              'venv.Lib.site-packages.mysql.connector.fabric', 'venv.Lib.site-packages.mysql.connector.locales',
              'venv.Lib.site-packages.mysql.connector.locales.eng', 'venv.Lib.site-packages.pycparser',
    ...
    license='',
    author='Ellis',
    author_email='ellisthompson.1999@outlook.com',
    description=''
)
